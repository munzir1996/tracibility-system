                        ...
                        <tr class="hover:bg-gray-200 text-right">
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                <form action="{{route('cteshippings.destroy', $cteshipping->id)}}" method="post">
                                    ...
                                    {{-- <a href="{{route('cteshippings.edit', $cteshipping->id)}}" class="px-2 py-2 bg-indigo-600 rounded-md text-white font-medium tracking-wide text-decoration-none hover:bg-indigo-500 ml-1">
                                        تعديل
                                    </a> --}}
